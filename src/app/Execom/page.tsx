...
const MemberCard = ({ member, index }: { member: ExecomMember; index: number }) => (
  <BlurFade key={member.id} delay={0.1 * index} inView>
    <div className="group relative rounded-2xl p-6 border border-[rgb(32,32,32)] hover:border-[rgb(54,54,54)] transition-all duration-300 hover:scale-105">
      {/* Spotlight Effect */}
      ...
      <div className="relative z-10">
        <h3 className="text-white text-xl font-jetbrains-mono font-semibold mb-2 tracking-tight">
          {member.name}
        </h3>
        <p className="text-gray-300 text-sm font-jetbrains-mono mb-4 opacity-80">
          {member.position}
        </p>
        ...
        <div className="flex gap-3 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
          ...
          {member.linkedin && (
            <a
              ...
              className="flex items-center justify-center w-8 h-8 bg-blue-700 hover:bg-blue-800 rounded-full transition-colors duration-200"
              title="LinkedIn"
            >
              <svg className="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 20 20">
...
export default function Execom() {
  ...
  return (
    <BlurFade delay={0.25} inView>
      <Wrapper curIndex={2}>
        <div className="w-full min-h-screen flex flex-col p-20">
          {/* Main Title */}
          <BlurFade delay={0.4} inView>
            <div className="flex w-full h-20 justify-between items-center mt-8 mb-12">
              <h1 className="text-white text-4xl font-jetbrains-mono tracking-tighter">
                Execom Members
              </h1>
            </div>
          </BlurFade>
          ...
          <div className="mb-16">
            <h2 className="text-white text-2xl font-jetbrains-mono font-semibold mb-8 tracking-tight">
              Core Committee
            </h2>
